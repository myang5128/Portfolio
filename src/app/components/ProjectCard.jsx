...
const ProjectCard = ({ imgUrl, title, description, gitUrl, previewUrl, backgroundVar }) => {
  return (
    <div>
      <div
        className="h-52 md:h-72 rounded-t-xl relative group"
        style={{ background: `url(${imgUrl})`, backgroundSize: backgroundVar }}>
        <div
      ...
      <div className="text-white rounded-b-xl mt-4 bg-[#121212] py-6 px-4">
