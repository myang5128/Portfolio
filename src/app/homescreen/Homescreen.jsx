...
const Homescreen = () => {
  return (
    <main className="flex flex-col items-center p-10 sm:m-4 justify-center sm-2 w-full">
        <div className="p-0 w-full flex flex-col items-center">
          <div className="flex justify-center">
            <h1 className="text-[#888E7B] md:text-8xl sm:text-6xl text-4xl">Michael Yang</h1>
          </div>
          <div className="flex lg:flex-row flex-col justify-between sm:mt-30 mt-20 items-center w-full px-10">
